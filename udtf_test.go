...
func (d *incTableUDF) Columns() []ColumnMetaData {
...
func (d *structTableUDF) Columns() []ColumnMetaData {
	return []ColumnMetaData{
...
func (d *incTableNamedUDF) Columns() []ColumnMetaData {
	return []ColumnMetaData{
		{Name: "result", T: Ti64},
	}
}
...
func (d *chunkIncTableUDF) Columns() []ColumnMetaData {
	return []ColumnMetaData{
		{Name: "result", T: Ti64},
	}
}
